...
/**
 * Points of Interest per location preset (TerraMavuno / Kenya).
 *
 ...
 * eligibility engine all agree on where a ward is.
 *
 * Field reference:
 ...
 *   buildingHeight — estimated height of the target above ground (meters).
 *                    Rural wards have no landmark mass, so this is 0 and the
 *                    camera targets the ground itself.
 *   groundElevation — fallback terrain height used before terrain loads.
 *                     The Murang'a highlands sit around 1,500 m; Nairobi 1,660 m.
 */
export const CITY_POIS = {
  kandara: {
    name: 'Kandara',
    groundElevation: 1550,
    viewBounds: { southwest: { lat: -0.97, lng: 36.89 }, northeast: { lat: -0.81, lng: 37.10 } },
    pois: [
      { name: "Ng'araria ward", lat: -0.93588, lon: 37.02661, alt: 4200, pitch: -34, heading: 15, buildingHeight: 0 },
      { name: 'Muruka ward', lat: -0.92609, lon: 37.05547, alt: 4200, pitch: -34, heading: 340, buildingHeight: 0 },
      { name: 'Kagundu-ini ward', lat: -0.90542, lon: 37.07060, alt: 4200, pitch: -34, heading: 300, buildingHeight: 0 },
      { name: 'Gaichanjiru ward', lat: -0.87136, lon: 37.04936, alt: 4200, pitch: -34, heading: 200, buildingHeight: 0 },
      { name: 'Ithiru ward', lat: -0.88043, lon: 36.98795, alt: 4200, pitch: -34, heading: 90, buildingHeight: 0 },
      { name: 'Ruchu ward', lat: -0.83148, lon: 36.92132, alt: 4200, pitch: -34, heading: 120, buildingHeight: 0 },
    ],
  },
  muranga: {
    name: "Murang'a",
    groundElevation: 1500,
    viewBounds: { southwest: { lat: -1.06, lng: 36.60 }, northeast: { lat: -0.50, lng: 37.42 } },
    pois: [
      { name: "Murang'a county", lat: -0.80716, lon: 37.02909, alt: 46000, pitch: -50, heading: 0, buildingHeight: 0 },
      { name: 'Kabati town', lat: -0.90000, lon: 36.98000, alt: 3000, pitch: -30, heading: 20, buildingHeight: 12 },
      { name: 'Kenol town', lat: -0.99000, lon: 37.12000, alt: 3000, pitch: -30, heading: 340, buildingHeight: 12 },
      { name: 'NCPB Sagana Depot', lat: -0.66000, lon: 37.20000, alt: 2500, pitch: -32, heading: 240, buildingHeight: 10 },
      { name: 'Kandara constituency', lat: -0.85000, lon: 36.95000, alt: 22000, pitch: -45, heading: 10, buildingHeight: 0 },
    ],
  },
  nairobi: {
    name: 'Nairobi',
    groundElevation: 1660,
    viewBounds: { southwest: { lat: -1.44, lng: 36.66 }, northeast: { lat: -1.16, lng: 37.05 } },
    pois: [
      { name: 'Kenyatta International Convention Centre', lat: -1.2889, lon: 36.8233, alt: 620, pitch: -24, heading: 200, buildingHeight: 105 },
      { name: 'Uhuru Park', lat: -1.2921, lon: 36.8155, alt: 900, pitch: -32, heading: 60, buildingHeight: 0 },
      { name: 'Kilimo House (MoALD)', lat: -1.2872, lon: 36.8215, alt: 500, pitch: -25, heading: 180, buildingHeight: 30 },
      { name: 'Nairobi National Park', lat: -1.3667, lon: 36.8500, alt: 9000, pitch: -40, heading: 0, buildingHeight: 0 },
      { name: 'Jomo Kenyatta International Airport', lat: -1.3192, lon: 36.9278, alt: 4200, pitch: -35, heading: 240, buildingHeight: 20 },
    ],
  },
};
 ...
 * in the ported action runner — see docs/ported/gev-action-runner-contract.md) so downstream
 * context/screenshot policy treats it as a globe view,
...
export async function searchAndFlyTo(viewer, query, options = {}) {
  ...
  if (!requestedRange && !options.forceClose
    ...
    // of Hawaii", action-runner `viewMode: 'overview'`). That is an explicit
